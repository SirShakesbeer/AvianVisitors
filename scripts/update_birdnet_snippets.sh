...
case "$origin" in
  https://github.com/Twarner491/AvianVisitors|https://github.com/Twarner491/AvianVisitors.git|https://github.com/SirShakesBeer/AvianVisitors|https://github.com/SirShakesBeer/AvianVisitors.git|git@github.com:SirShakesBeer/AvianVisitors.git) ;;
